...
public class Canon {
 ...
 static boolean commute(Tree.Stm a, Tree.Expv b) {
    return isNop(a)
 ...
 static StmExpList reorder(Tree.ExpList exps) {
     if (exps==null) return nopNull;
       ...
       Tree.Expv a = exps.head;
       if (a instanceof Tree.CALL) {
         Temp.Temp t = new Temp.Temp();
	 Tree.Expv e = new Tree.ESEQ(new Tree.MOVE(new Tree.TEMP(t), a),
				    new Tree.TEMP(t));
