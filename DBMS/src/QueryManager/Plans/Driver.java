...
public class Driver {
	...
	public static void main(String args[]){
		...
		System.out.println(plan.uni.size());
		System.out.println(plan.lqplist.get(0).plans.size());
//		ttp.print();
//		System.out.println(ttp.sqlExp.print(""));
//		System.out.println(ttp.sqlExpType);
//		System.out.println(ttp.selectBinExpCount);
