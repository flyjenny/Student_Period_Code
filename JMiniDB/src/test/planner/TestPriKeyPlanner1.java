...
public class TestPriKeyPlanner1 extends TestPlanner {

	@Test
	public void testUpdatePriKey1() {
		clean();
		Planner p = getPlane();
		int u = p.executeUpdatePassStr("update t set t.a=20 where t.a = 10",
				null);
		JMiniDB.Close();
	}
	...
	public void testUpdatePriKey2() {
		...
		Planner p = getPlane();
		try {
			int u = p.executeUpdatePassStr("update t set t.a=0 where t.a=10",
					null);
	...
	public static void clean() {
		TestPlanner.clean();
		Planner p = getPlane();
		p.executeUpdatePassStr("create table t (a int primary key)", null);
