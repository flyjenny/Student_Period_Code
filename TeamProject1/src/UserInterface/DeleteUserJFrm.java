			...
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				}
				{
					...
					DelUserJButton1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							System.out.println("DelUserJButton1.actionPerformed, event="+evt);
							//TODO add your code for DelUserJButton1.actionPerformed
							if (userInfo.getUserName(Integer.parseInt(stuNoJTextField1.getText())) != null){
								UserInfo_Delete_Conferm newWindow = new UserInfo_Delete_Conferm(userInfo, Integer.parseInt(stuNoJTextField1.getText()), DeleteUserJFrm.this);
				...
				}
				{
					...
					ExitJButton1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							System.out.println("ExitJButton1.actionPerformed, event="+evt);
							//TODO add your code for ExitJButton1.actionPerformed
