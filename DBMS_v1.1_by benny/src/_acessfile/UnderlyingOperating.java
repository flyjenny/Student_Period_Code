...
public class UnderlyingOperating {
	...
	/**
	 * Read disk content into bytebuffer according to page number.
	 * @param pageNum
	 * @param bytebuffer
	...
	/**
	 * Write bytebuffer into disk according to page number.
	 * @param pageNum
	 * @param bytebuffer
	 * @return 1 for successful,-1 for failure. 
	 */
	...
	public static void main(String args[]) throws IOException {
		...
		// ran.write_page(1, str);
		ran.read_page(0, buffer);
		byte bbb[]=new byte[4096];
		System.arraycopy(buffer, 0, bbb, 0, 4096);
		String abc = new String(bbb);
