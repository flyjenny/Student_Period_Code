...
public class LogicalQueryPlan {
	...
	public LogicalQueryPlan(PreTreeToPlan pre) {
		...
		/*
		 * System.out.println("preTreeToPlan.selectBinExpCount = "+preTreeToPlan.
		 * selectBinExpCount);
		 * System.out.println("preTreeToPlan.sqlExpType = "+preTreeToPlan
		 * .sqlExpType);
	...
	/**
	 * @param tmp
	 * @return 没有union，属于SFW，//where中没有and 和 or
	 */
