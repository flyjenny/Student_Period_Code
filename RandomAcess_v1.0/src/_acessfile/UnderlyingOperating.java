...
public class UnderlyingOperating {
	...
	/*return the number of page in the virtual disk*/
	...
	public int read_page(int pageNum,byte[] bytebuffer){
		if(pageNum >= filesize){
			System.out.println("Block "+pageNum+" requirement is out of file size");
			return -1;
		}
		try {
	...
	public static void main(String args[]) throws IOException{
		...
		String str = "ENGLISH STORY Third Series i Edited by W0DRW WYATT COLLINS 48 PALL MALL LONDON 194 THIS BOOK " +
...
//		String str="h";
		char a[]=new char[10];
		String test="hello/";
		String[] chen=test.split("/");
		
		
		
		FileStruct fs1=new FileStruct('y',"table1",1,50);
		FileStruct fs2=new FileStruct('n',"table2",51,50);
		
		ran.read_page(253, buffer);
